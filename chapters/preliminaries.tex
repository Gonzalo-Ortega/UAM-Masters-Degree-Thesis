...
\begin{definition}[Bottleneck distance] \label{def:bot-dist-1}
...
\begin{definition}[Bottleneck distance] \label{def:bot-dist-2}
...
\begin{example}[Wasserstein distance] \label{ex:wasserstein}
